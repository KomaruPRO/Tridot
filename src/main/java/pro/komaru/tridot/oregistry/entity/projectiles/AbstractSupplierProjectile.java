package pro.komaru.tridot.oregistry.entity.projectiles;
...
public abstract class AbstractSupplierProjectile extends AbstractTridotArrow implements ItemSupplier{
    ...
    public void processVelocityDamage(LivingEntity thrower, Entity entity, DamageSource damagesource) {
        ...
        int damage = Mth.ceil(Mth.clamp(velocity * this.getBaseDamage(), 0, Integer.MAX_VALUE));
        if (this.isCritArrow()) {
