 ...
 * the License.
 */
package pro.komaru.tridot.snakeyaml.parser;

import java.util.HashMap;
import java.util.LinkedList;
import java.util.List;
import java.util.Map;
import pro.komaru.tridot.snakeyaml.DumperOptions;
import pro.komaru.tridot.snakeyaml.DumperOptions.Version;
import pro.komaru.tridot.snakeyaml.LoaderOptions;
import pro.komaru.tridot.snakeyaml.comments.CommentType;
import pro.komaru.tridot.snakeyaml.error.Mark;
import pro.komaru.tridot.snakeyaml.error.YAMLException;
import pro.komaru.tridot.snakeyaml.events.AliasEvent;
import pro.komaru.tridot.snakeyaml.events.CommentEvent;
import pro.komaru.tridot.snakeyaml.events.DocumentEndEvent;
import pro.komaru.tridot.snakeyaml.events.DocumentStartEvent;
import pro.komaru.tridot.snakeyaml.events.Event;
import pro.komaru.tridot.snakeyaml.events.ImplicitTuple;
import pro.komaru.tridot.snakeyaml.events.MappingEndEvent;
import pro.komaru.tridot.snakeyaml.events.MappingStartEvent;
import pro.komaru.tridot.snakeyaml.events.ScalarEvent;
import pro.komaru.tridot.snakeyaml.events.SequenceEndEvent;
import pro.komaru.tridot.snakeyaml.events.SequenceStartEvent;
import pro.komaru.tridot.snakeyaml.events.StreamEndEvent;
import pro.komaru.tridot.snakeyaml.events.StreamStartEvent;
import pro.komaru.tridot.snakeyaml.nodes.Tag;
import pro.komaru.tridot.snakeyaml.reader.StreamReader;
import pro.komaru.tridot.snakeyaml.scanner.Scanner;
import pro.komaru.tridot.snakeyaml.scanner.ScannerImpl;
import pro.komaru.tridot.snakeyaml.tokens.AliasToken;
import pro.komaru.tridot.snakeyaml.tokens.AnchorToken;
import pro.komaru.tridot.snakeyaml.tokens.BlockEntryToken;
import pro.komaru.tridot.snakeyaml.tokens.CommentToken;
import pro.komaru.tridot.snakeyaml.tokens.DirectiveToken;
import pro.komaru.tridot.snakeyaml.tokens.ScalarToken;
import pro.komaru.tridot.snakeyaml.tokens.StreamEndToken;
import pro.komaru.tridot.snakeyaml.tokens.StreamStartToken;
import pro.komaru.tridot.snakeyaml.tokens.TagToken;
import pro.komaru.tridot.snakeyaml.tokens.TagTuple;
import pro.komaru.tridot.snakeyaml.tokens.Token;
import pro.komaru.tridot.snakeyaml.util.ArrayStack;
