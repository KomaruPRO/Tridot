package pro.komaru.tridot.client.effect;
...
import pro.komaru.tridot.client.particle.behavior.SparkParticleBehavior;
import pro.komaru.tridot.client.particle.behavior.SphereParticleBehavior;
import pro.komaru.tridot.client.particle.behavior.TrailParticleBehavior;
...
import pro.komaru.tridot.client.particle.data.SpinParticleData;
import pro.komaru.tridot.client.render.RenderBuilder;
import pro.komaru.tridot.client.gui.screenshake.PositionedScreenshakeInstance;
...
import pro.komaru.tridot.client.shader.postprocess.GlowPostProcessInstance;
...
public class TridotEffects{
    ...
    public static void lightningBoltRender(LightningBolt entity, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource buffer, int packedLight){
        RenderBuilder builder = RenderBuilder.create().setRenderType(TridotRenderTypes.ADDITIVE);
