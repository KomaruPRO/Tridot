...
import pro.komaru.tridot.client.graphics.render.trail.TrailPoint;
import pro.komaru.tridot.client.graphics.render.trail.TrailRenderPoint;
...
public class RenderBuilder{
    ...
    public int l1 = Utils.RenderUtil.FULL_BRIGHT;
    public int l2 = Utils.RenderUtil.FULL_BRIGHT;
    public int l3 = Utils.RenderUtil.FULL_BRIGHT;
    ...
    public RenderBuilder renderCube(Matrix4f last, Vector3f[] positions){
        if(firstSide){
            ...
            supplier.placeVertex(getVertexConsumer(), last, this, positions[6].x(), positions[6].y(), positions[6].z(), r1, g1, b1, a1, u2, v3, l1);
            supplier.placeVertex(getVertexConsumer(), last, this, positions[5].x(), positions[5].y(), positions[5].z(), r1, g1, b1, a1, u3, v3, l1);
            supplier.placeVertex(getVertexConsumer(), last, this, positions[2].x(), positions[2].y(), positions[2].z(), r1, g1, b1, a1, u3, v2, l1);
            supplier.placeVertex(getVertexConsumer(), last, this, positions[1].x(), positions[1].y(), positions[1].z(), r1, g1, b1, a1, u2, v2, l1);
            ...
            supplier.placeVertex(getVertexConsumer(), last, this, positions[7].x(), positions[7].y(), positions[7].z(), r1, g1, b1, a1, u4, v5, l1);
            supplier.placeVertex(getVertexConsumer(), last, this, positions[6].x(), positions[6].y(), positions[6].z(), r1, g1, b1, a1, u5, v5, l1);
            supplier.placeVertex(getVertexConsumer(), last, this, positions[1].x(), positions[1].y(), positions[1].z(), r1, g1, b1, a1, u5, v4, l1);
            supplier.placeVertex(getVertexConsumer(), last, this, positions[0].x(), positions[0].y(), positions[0].z(), r1, g1, b1, a1, u4, v4, l1);
        }
    ...
    public RenderBuilder renderRay(Matrix4f last, Vector3f[] positions){
        if(firstSide){
            ...
            supplier.placeVertex(getVertexConsumer(), last, this, positions[6].x(), positions[6].y(), positions[6].z(), r1, g1, b1, a1, u2, v3, l1);
            supplier.placeVertex(getVertexConsumer(), last, this, positions[5].x(), positions[5].y(), positions[5].z(), r1, g1, b1, a1, u3, v3, l1);
            supplier.placeVertex(getVertexConsumer(), last, this, positions[2].x(), positions[2].y(), positions[2].z(), r2, g2, b2, a2, u3, v2, l2);
            supplier.placeVertex(getVertexConsumer(), last, this, positions[1].x(), positions[1].y(), positions[1].z(), r2, g2, b2, a2, u2, v2, l2);
            ...
            supplier.placeVertex(getVertexConsumer(), last, this, positions[7].x(), positions[7].y(), positions[7].z(), r1, g1, b1, a1, u4, v5, l1);
            supplier.placeVertex(getVertexConsumer(), last, this, positions[6].x(), positions[6].y(), positions[6].z(), r1, g1, b1, a1, u5, v5, l1);
            supplier.placeVertex(getVertexConsumer(), last, this, positions[1].x(), positions[1].y(), positions[1].z(), r2, g2, b2, a2, u5, v4, l2);
            supplier.placeVertex(getVertexConsumer(), last, this, positions[0].x(), positions[0].y(), positions[0].z(), r2, g2, b2, a2, u4, v4, l2);
        }
    ...
    public RenderBuilder renderWavyQuad(PoseStack stack, float width, float height, float strength, float time){
        Vector3f[] positions = new Vector3f[]{new Vector3f(-1, 1, 0), new Vector3f(1, 1, 0), new Vector3f(1, -1, 0), new Vector3f(-1, -1, 0)};
        Utils.RenderUtil.applyWobble(positions, strength, time);
        return renderQuad(stack, positions, width, height);
    }
    ...
    public RenderBuilder renderTrail(Matrix4f pose, List<TrailPoint> trailSegments, Function<Float, Float> widthFunc, Consumer<Float> vfxOperator){
        ...
        for(int i = 1; i < count; i++){
            ...
            points[i] = new TrailRenderPoint(current, Utils.RenderUtil.perpendicularTrailPoints(previous, next, width));
        }
        points[0] = new TrailRenderPoint(positions.get(0), Utils.RenderUtil.perpendicularTrailPoints(positions.get(0), positions.get(1), widthFunc.apply(0f)));
        points[count] = new TrailRenderPoint(positions.get(count), Utils.RenderUtil.perpendicularTrailPoints(positions.get(count - 1), positions.get(count), widthFunc.apply(1f)));
    ...
    public RenderBuilder renderSphere(PoseStack stack, float radius, int longs, int lats, float endU, boolean stretch){
        ...
        for(int i = 0; i < longs; ++i){
            for(int j = 0; j < lats; ++j){
                ...
                Vector3f p0 = Utils.RenderUtil.parametricSphere(u, v, radius);
                Vector3f p1 = Utils.RenderUtil.parametricSphere(u, vn, radius);
                Vector3f p2 = Utils.RenderUtil.parametricSphere(un, v, radius);
                Vector3f p3 = Utils.RenderUtil.parametricSphere(un, vn, radius);
