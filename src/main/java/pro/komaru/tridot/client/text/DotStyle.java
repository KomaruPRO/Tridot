...
public class DotStyle extends Style {
    ...
    static Map<String, DotStyleEffect> FX = new LinkedHashMap<>();

    public static void register(ResourceLocation effectId, DotStyleEffect effectObject) {
        effectObject.id = effectId;
        FX.put(effectId.toString(),effectObject);
    }
    ...
    public DotStyle effect(ResourceLocation location) {
        return effect(DotStyle.FX.get(location.toString()));
    }
