...
public class AttributeRegistry {
    ...
    public static final RegistryObject<Attribute> PERCENT_ARMOR = ATTRIBUTES.register("percent_armor", () -> new RangedAttribute("attribute.tridot.percent_armor", 0.0D, 0.0D, 100.0D).setSyncable(true));
