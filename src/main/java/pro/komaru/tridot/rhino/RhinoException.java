...
public abstract class RhinoException extends RuntimeException {
	...
	public ScriptStackElement[] getScriptStack(int limit, String hideFunction) {
		...
		for (StackTraceElement e : stack) {
			...
			} else if ("pro.komaru.tridot.rhino.Interpreter".equals(e.getClassName()) && "interpretLoop".equals(e.getMethodName()) && interpreterStack != null && interpreterStack.length > interpreterStackIndex) {
