...
import github.iri.tridot.client.gui.*;
...
import static github.iri.tridot.TridotLib.BASE_DASH_DISTANCE_UUID;
...
public class KatanaItem extends SwordItem implements CooldownNotifyItem, DashItem, CooldownReductionItem {
    ...
    public KatanaItem(Tier tier, int attackDamageIn, float attackSpeedIn, float dashDistance, Properties builderIn) {
