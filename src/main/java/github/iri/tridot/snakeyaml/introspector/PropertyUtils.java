 ...
 * the License.
 */
package github.iri.tridot.snakeyaml.introspector;
...
import github.iri.tridot.snakeyaml.introspector.BeanAccess;
import github.iri.tridot.snakeyaml.introspector.FieldProperty;
import github.iri.tridot.snakeyaml.introspector.Property;
import github.iri.tridot.snakeyaml.util.PlatformFeatureDetector;
...
public class PropertyUtils {
  ...
  private github.iri.tridot.snakeyaml.introspector.BeanAccess beanAccess = github.iri.tridot.snakeyaml.introspector.BeanAccess.DEFAULT;
  ...
  PropertyUtils(PlatformFeatureDetector platformFeatureDetector) {
    ...
    if (!platformFeatureDetector.isIntrospectionAvailable()) {
      beanAccess = github.iri.tridot.snakeyaml.introspector.BeanAccess.FIELD;
    }
  }

  protected Map<String, Property> getPropertiesMap(Class<?> type, github.iri.tridot.snakeyaml.introspector.BeanAccess bAccess) {
    ...
    if (bAccess == github.iri.tridot.snakeyaml.introspector.BeanAccess.FIELD) {
  ...
  public Set<Property> getProperties(Class<? extends Object> type, github.iri.tridot.snakeyaml.introspector.BeanAccess bAccess) {
  ...
  protected Set<Property> createPropertySet(Class<? extends Object> type, github.iri.tridot.snakeyaml.introspector.BeanAccess bAccess) {
  ...
  public Property getProperty(Class<? extends Object> type, String name, github.iri.tridot.snakeyaml.introspector.BeanAccess bAccess) {
  ...
  public void setBeanAccess(github.iri.tridot.snakeyaml.introspector.BeanAccess beanAccess) {
