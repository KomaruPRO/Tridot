 ...
 * the License.
 */
package github.iri.tridot.snakeyaml.extensions.compactnotation;

import github.iri.tridot.snakeyaml.LoaderOptions;
import github.iri.tridot.snakeyaml.constructor.Construct;
import github.iri.tridot.snakeyaml.constructor.Constructor;
import github.iri.tridot.snakeyaml.error.YAMLException;
import github.iri.tridot.snakeyaml.extensions.compactnotation.CompactData;
import github.iri.tridot.snakeyaml.introspector.Property;
import github.iri.tridot.snakeyaml.nodes.*;
...
public class CompactConstructor extends Constructor {
  ...
  protected Object constructCompactFormat(ScalarNode node, github.iri.tridot.snakeyaml.extensions.compactnotation.CompactData data) {
    try {
  ...
  protected Object createInstance(ScalarNode node, github.iri.tridot.snakeyaml.extensions.compactnotation.CompactData data) throws Exception {
  ...
  public github.iri.tridot.snakeyaml.extensions.compactnotation.CompactData getCompactData(String scalar) {
    if (!scalar.endsWith(")")) {
      return null;
    }
    if (scalar.indexOf('(') < 0) {
    ...
    if (m.matches()) {
      ...
      github.iri.tridot.snakeyaml.extensions.compactnotation.CompactData data = new github.iri.tridot.snakeyaml.extensions.compactnotation.CompactData(tag);
      if (content.isEmpty()) {
        return data;
      }
