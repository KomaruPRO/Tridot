 ...
 * the License.
 */
package github.iri.tridot.snakeyaml.comments;
...
public class CommentEventsCollector {
  ...
  private final github.iri.tridot.snakeyaml.comments.CommentType[] expectedCommentTypes;
   ...
   *        collected.
   */
  public CommentEventsCollector(final Parser parser, github.iri.tridot.snakeyaml.comments.CommentType... expectedCommentTypes) {
   ...
   *        collected.
   */
  public CommentEventsCollector(Queue<Event> eventSource, github.iri.tridot.snakeyaml.comments.CommentType... expectedCommentTypes) {
